Para forecasting em geral, ver livro (on-line) [Forecasting: Principles and Practice](https://otexts.com/fpp2/). Este livro usa o package *forecast* de R. Para Python uma possibilidade é usar *forecast* com https://pypi.org/project/rpy2/. 

Implementação de Exponential smoothing em Python:
